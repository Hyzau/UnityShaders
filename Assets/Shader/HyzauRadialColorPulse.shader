    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float a = color.a;
                float2 coordCentered = IN.texcoord * 2 - 1;
                float radialDistance = length(coordCentered);
                float wave = abs(cos((radialDistance - _Time.y) * _Frequency )) - _Delay;
